  ...
  <div class="introduce">
    <div class="card">
      ...
      <div class="card-content">
        ...
        <div class="username">yoshita</div>
  ...
  .card {
    ...
    .card-borders {
      ...
      .border-bottom {
        ...
        background: var(--card-bg-color);
        transform: translateX(100%);
        animation: slide-in-horizontal-revise 0.8s
      ...
      .border-left {
        ...
        background: var(--card-bg-color);
        transform: translateY(-100%);
        animation: slide-in-vertical-revise 0.8s
          cubic-bezier(0.645, 0.045, 0.355, 1) forwards;
      }
    }
    // 背景容器设置 这里动画出现的关键帧差距时间有点意思
    .card-content {
      display: flex;
      ...
      .social-icons {
        ...
        .social-icon {
          ...
          // 彼此慢了0.1s达到了视觉切换 三个不同的差一秒得到不同的效果
...
@keyframes slide-in-horizontal-revise {
  50% {
    transform: translateX(0);
  }
  to {
...
@keyframes slide-in-vertical-revise {
  50% {
    transform: translateY(0);
  }
  to {
